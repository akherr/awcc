...
ALTER TABLE `Program_Requests`
  ADD PRIMARY KEY (`ProgramRequestID`), ADD KEY `fk_38BC89BB-2A94-4633-94F9-110911028F7A` (`ProgramTypeID`), ADD KEY `fk_3AC84605-658F-4540-8221-7B27587A6E49` (`GroupTypeID`);
