...
--
-- Host: localhost
-- Generation Time: May 26, 2016 at 04:37 PM
...
CREATE TABLE IF NOT EXISTS `notes` (
  ...
  `program_request_id` int(11) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `program_requests` (
  `program_request_id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `program_req_status` (
  `program_req_status_id` int(11) NOT NULL,
...
--
ALTER TABLE `notes`
  ADD PRIMARY KEY (`note_id`), ADD KEY `fk_80FAB6EE-1871-49E8-A140-52FC0A36548E` (`program_request_id`), ADD KEY `note_content` (`note_content`(255)), ADD KEY `note_author` (`note_author`);

--
-- Indexes for table `program_requests`
--
ALTER TABLE `program_requests`
  ADD PRIMARY KEY (`program_request_id`), ADD KEY `fk_38BC89BB-2A94-4633-94F9-110911028F7A` (`program_type_id`), ADD KEY `fk_3AC84605-658F-4540-8221-7B27587A6E49` (`group_type_id`), ADD KEY `assigned_user_id` (`assigned_user_id`);
...
--
ALTER TABLE `group_types`
  MODIFY `group_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `program_requests`
  MODIFY `program_request_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `program_types`
--
ALTER TABLE `program_types`
  MODIFY `program_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `status_types`
--
ALTER TABLE `status_types`
  MODIFY `status_type_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
