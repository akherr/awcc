...
--
-- Host: localhost
-- Generation Time: May 24, 2016 at 03:35 PM
...
CREATE TABLE IF NOT EXISTS `Program_Req_Status` (
  `Program_Req_StatusID` int(11) NOT NULL,
  `Program_Req_ID` int(11) DEFAULT NULL,
...
ALTER TABLE `Program_Requests`
  ADD PRIMARY KEY (`ProgramRequestID`), ADD KEY `fk_38BC89BB-2A94-4633-94F9-110911028F7A` (`ProgramTypeID`), ADD KEY `fk_3AC84605-658F-4540-8221-7B27587A6E49` (`GroupTypeID`), ADD KEY `AssignedUserID` (`AssignedUserID`);

--
-- Indexes for table `Program_Req_Status`
--
ALTER TABLE `Program_Req_Status`
  ADD KEY `Program_Req_ID` (`Program_Req_ID`), ADD KEY `Status_Type_ID` (`Status_Type_ID`), ADD KEY `User_ID` (`User_ID`);
...
--
ALTER TABLE `Program_Requests`
  MODIFY `ProgramRequestID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `Program_Types`
--
ALTER TABLE `Program_Types`
  MODIFY `ProgramTypeID` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `Program_Requests`
ADD CONSTRAINT `Program_Requests_ibfk_1` FOREIGN KEY (`AssignedUserID`) REFERENCES `user` (`user_ID`),
...
--
ALTER TABLE `Program_Req_Status`
ADD CONSTRAINT `Program_Req_Status_ibfk_3` FOREIGN KEY (`User_ID`) REFERENCES `user` (`user_ID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `Program_Req_Status_ibfk_1` FOREIGN KEY (`Program_Req_ID`) REFERENCES `Program_Requests` (`ProgramRequestID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
ADD CONSTRAINT `Program_Req_Status_ibfk_2` FOREIGN KEY (`Status_Type_ID`) REFERENCES `Status_Types` (`StatusTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
