...
$sql = "INSERT INTO `Program_Requests` (`ProgramTypeID`, `GroupTypeID`, `AssignedUserID`, `StatusTypeID`, `FirstName`, `LastName`, `Phone`, `Email`, `Company`, `Role`, `ProposedLocation`, `ProposedDate`, `NumberParticipants`, `EstimatedCost`, `ClientMessage`, `UpdateTime`, `CreatedDate`)"
        . " VALUES(1, 1, 1, 1, '$_POST[first_name]', '$_POST[last_name]', '$_POST[phone]', '$_POST[edress]', '$_POST[organization]', '$_POST[role]', '$_POST[ProgramLocation]', '$_POST[ProgramDate]', '$_POST[NumberParticipants]', '$_POST[EstimatedCost]', 'TEST MESSAGE', '2016-05-21 16:00:55', '0000-00-00 00:00:00')";
